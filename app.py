...
if uploaded_file:
    ...
    # Model dan Tuning
    st.header("3. Pelatihan Model (Random Forest + GridSearchCV)")
    param_grid = {
    ...
    st.download_button("Download Laporan Evaluasi", pd.DataFrame(report).transpose().to_csv(), file_name='evaluasi_model.csv')
